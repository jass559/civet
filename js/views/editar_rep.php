...
$conn = pg_connect("host=$host port=$port dbname=$dbname user=$user password=$password");
    ...
    $query = "SELECT * FROM public.items_copy1 WHERE id = $id";
  ...
  <div class="container div-1">
    <header class="d-flex flex-wrap justify-content-center  py-3 mb-4 border-bottom">
      ...
      <!--<ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="#" class="nav-link">Ver Todo</a></li>
        <li class="nav-item"><a href="#" class="nav-link">Borrar </a></li>
        <li class="nav-item"><a href="#" class="nav-link">Modificar </a></li>
        ...
        <form class="needs-validation"  action="../includes/_functions.php" method="POST" novalidate>
            ...
            <div class="row ">
              ...
              <div class="form-floating col-md-2 col-6">
                <input type="text" name="comfor" id="comfor" class="form-control" value="<?php echo ($rep['conforme_part']== null ? "0" :$rep["conforme_part"] )?>" required>
                <label class="form-label" for="comfor">Comforme:</label>
                       
              </div>
              <div class="form-floating col-md-2 col-6">
                <input type="text" name="salva" id="salva" class="form-control" value="<?php echo  ( $rep["salvamento_part"] == null ? "0" :$rep['salvamento_part']) ?>" required>
                <label class="form-label" for="salva">Salvamento:</label>
                       
              </div>
              <div class="form-floating col-md-2 col-6">
                <input type="text" name="scrap" id="scrap" class="form-control" value="<?php echo ($rep['scrap_part']== null ? "0" :$rep["scrap_part"] )?>" required>
